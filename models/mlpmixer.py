...
def FeedForward(dim, expansion_factor=4, dropout=0., dense=L.Linear):
...
def MLPMixer(*, image_size, channels, patch_size, dim, depth, num_classes, expansion_factor=4, expansion_factor_token=0.5, dropout=0.):
    ...
    chan_first, chan_last = partial(nn.Conv1d, kernel_size=1), L.Linear

    return nn.Sequential(
        Rearrange('b c (h p1) (w p2) -> b (h w) (p1 p2 c)',
                  p1=patch_size, p2=patch_size),
        L.Linear((patch_size ** 2) * channels, dim),
        *[nn.Sequential(
